...
import cz.vsb.austra.dto.openmeteo.DailyUnits;

public class HistoricalTimeSeriesDto {
    ...
    public DailyHistoryDto getDaily() {
        return daily;
    }

    public void setDaily(DailyHistoryDto daily) {
        this.daily = daily;
    }
}
